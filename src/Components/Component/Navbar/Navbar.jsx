...
import md5 from 'md5'; // ensure md5 installed
...
const Navbar = () => {
  ...
  const getProfileImage = () => {
    ...
    return 'https://i.ibb.co/LPLKhK5/default-avatar.png';
  };
  ...
  const menuItems = (
    <>
      <Link to="/" className="hover:text-yellow-400 transition" onClick={handleLinkClick}>Home</Link>
      <Link to="/contact" className="hover:text-yellow-400 transition" onClick={handleLinkClick}>Contact Us</Link>
      <Link to="/dashboard" className="hover:text-yellow-400 transition" onClick={handleLinkClick}>Dashboard</Link>
      <Link to="/menu" className="hover:text-yellow-400 transition" onClick={handleLinkClick}>Menu</Link>
      <Link to="/ourshop" className="text-green-400 font-bold flex items-center gap-2" onClick={handleLinkClick}>
        <span>Our Shop</span>
